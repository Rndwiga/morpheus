            ...
            <div class="page-sidebar sidebar horizontal-bar">
                <div class="page-sidebar-inner">
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink active open"><a href="#"><span class="menu-icon icon-envelope-open"></span><p>Mailbox</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="unread">
											...
											<td class="hidden-xs>
												<a href="#" class="btn btn-block">Google</a>
											</td>
											<td>
												<a href="#" class="btn btn-block">Nullam quis risus eget urna mollis ornare vel eu leo</a>
											</td>
											<td>
											</td>
											<td>
                                    ...
                                    <tr class="read">
                                        ...
                                        <td>
                                            <a href="message-view.html" class="btn btn-block">Nullam quis risus eget urna mollis ornare vel eu leo</a>
                                        </td>
                                        <td>
